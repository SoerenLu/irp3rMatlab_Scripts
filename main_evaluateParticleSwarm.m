...
PSO_alpha = 0.05;   %weight of random movement
PSO_beta = 0.1;    %weight of movement to current optimum
PSO_swarmsize = 100;
...
if(useRestingLengths)
    ...
    lineInExcelSheet = (i-1)*3+2;
    xlswrite(filename,dataTable,pathNo,['B', num2str(lineInExcelSheet)]);
...
%% Safe Parameters
     dataTable = {...
        ...
        filename = ['evaluate',globalOptimMethod,'_autogenerated.xlsx'];
        lineInExcelSheet = 2;
        xlswrite(filename,dataTable,'Parameters',['B', num2str(lineInExcelSheet)]);
